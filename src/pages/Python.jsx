...
const Python = () => {
  ...
  const posts =
    useSelector((state) => state.post.postsByCategory?.Python?.data) || [];

  const pagination =
    useSelector((state) => state.post.postsByCategory?.Python?.pagination) ||
    {};

  const count =
    useSelector((state) => state.post.postsByCategory?.Python?.count) || 0;
  ...
  return (
    <section className="business-page">
      {/* Header */}
      <h1 className="page-title">Python Posts ({count})</h1>
