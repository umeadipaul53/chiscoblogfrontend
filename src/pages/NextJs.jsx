...
const NextJs = () => {
  ...
  const pagination =
    useSelector((state) => state.post.postsByCategory?.NextJs?.pagination) ||
    {};

  const count =
    useSelector((state) => state.post.postsByCategory?.NextJs?.count) || 0;
  ...
  return (
    <section className="business-page">
      {/* Header */}
      <h1 className="page-title">NextJs Posts ({count})</h1>
