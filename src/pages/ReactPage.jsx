...
const ReactPage = () => {
  ...
  const posts =
    useSelector((state) => state.post.postsByCategory?.React?.data) || [];

  const pagination =
    useSelector((state) => state.post.postsByCategory?.React?.pagination) || {};

  const count =
    useSelector((state) => state.post.postsByCategory?.React?.count) || 0;
  ...
  return (
    <section className="business-page">
      <h1 className="page-title">React Posts ({count})</h1>
